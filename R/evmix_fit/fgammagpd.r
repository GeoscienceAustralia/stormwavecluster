# This code was provided by Carl Scarrot (March 2016) and contains some bugfixes
# of the then current version of the evmix package
#
# These have been modified by GD to remove parameter checks -- dangerous, but
# increases speed!
