...
#       If we have perturbed the data, then we should subtract the 'duration
#       jitter amount' from this (since it is possible our duration has been
#       randomly perturbed upward by that amount)
#
event_duration_years = (
    event_statistics$duration + 
    duration_gap_hours - 
    #FIXME#
    (duration_offset_hours + break_ties_with_jitter * default_jitter_amounts['duration'])
    )/year2hours 
