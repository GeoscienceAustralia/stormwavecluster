...
# What kind of copula was selected to model depenednce between season and hsig?
...
# What kind of copula was selected to model depenednce between season and duration?
...
```{r tideResidExtremeValueMixture}
