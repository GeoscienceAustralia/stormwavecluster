...
if(FALSE){
    ...
    for(tt in thresh_vals){
        gpd_fit = gpd.fit(event_statistics$hsig, threshold=tt)
        counter = counter + 1
        aep100[counter] = gpdq(gpd_fit$mle, u=tt, p=0.01 * data_duration_years/num_events)
    }
    summary(aep100[thresh_vals > 4])
