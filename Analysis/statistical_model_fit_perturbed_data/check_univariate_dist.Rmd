...
so random perturbations can lead to one or the other having best AIC. In all cases,
the most common family derived from the perturbed data is the same as the
family selected for the original data.
